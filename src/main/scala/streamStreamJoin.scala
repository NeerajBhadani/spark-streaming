...
// Ref : https://spark.apache.org/docs/latest/structured-streaming-programming-guide.html#stream-stream-joins
// Support for Stream-Stream Join added from Spark 2.3
